"""
Django settings for video_41484 project.
...
WSGI_APPLICATION = 'video_41484.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "video_41484 API",
    "DESCRIPTION": "API documentation for video_41484 App",
    "VERSION": "v1",
}
